        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Experience the world's finest cuisines with our curated collection of authentic dishes. 
              From traditional Italian pasta to spicy Indian curries, we bring global flavors to your table.
            </p>
